...
_,binaryWord = cv2.threshold(cv2.cvtColor(rotatedMask, cv2.cv.CV_BGR2GRAY), 2,255,cv2.THRESH_BINARY)
cv2.imshow("rotated", rotatedMask)
...
cv2.drawContours(binaryWord,[box],0,(255,255,0),-1)
